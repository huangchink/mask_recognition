...
try: 
    ...
    #建立池化層1
    model.add(MaxPooling2D(pool_size=(2, 2))) #(10,90,90)
    ...
    #建立池化層2
    model.add(MaxPooling2D(pool_size=(2, 2))) #(20,45,45)
    
    # Dropout層防止過度擬合，斷開比例:0.5
    model.add(Dropout(0.5))
    
    #建立平坦層：20*45*45=40500 個神經元
    model.add(Flatten()) 
...
try:
    ...
    img=cv2.imread('0_0_chenglong_0070.jpg')
    ...
    img=cv2.imread('0_0_0 copy 65.jpg')
...
# 偵測人臉
face_rects, scores, idx = detector.run(img, 0,0.2)
...
for i, d in enumerate(face_rects):
  ...
  # 以方框標示偵測的人臉
    ...
    if guess[i]==0:
        ...
        cv2.putText(img, text, (x1, y1-10), cv2.FONT_HERSHEY_DUPLEX,
